              ...
              {memory.additionalImages.map((imgSrc, index) => (
                ...
                >
                  {imgSrc ? (
                    ...
                    <div className="w-full aspect-[4/3] bg-gradient-to-br from-rose-50 to-rose-100 flex flex-col items-center justify-center gap-3">
                      <div className="w-16 h-16 rounded-full bg-white/60 flex items-center justify-center border-2 border-dashed border-rose-200">
                      ...
                      <span className="text-rose-400 text-sm font-medium" style={{ fontFamily: "'Lora', serif" }}>
                        Photo {index + 1}
                      </span>
                    </div>
                  )}
